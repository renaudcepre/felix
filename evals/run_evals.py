...
# ---------------------------------------------------------------------------
# Unified pipeline dataset — single import covering all capabilities
# Fixtures: evals/fixtures/unified/ (Thornwall Keep scenario + long_mission for segmentation)
# Characters: Borin (blacksmith 52), Elara (spy, blonde/black contradiction),
#   Darya (herbalist 30, green eyes), Maren (archivist 20), ORACLE (mechanism/AI),
#   Sentinels (group), Varn (mentioned), Hale (mentioned dead), Ferris (mentioned)
# + Daria Kovacs, Finn Osei, Luno (from long_mission for segmentation)
# ---------------------------------------------------------------------------

UNIFIED_DATASET: Dataset[str, Any] = Dataset(
    cases=[
        # --- extraction ---
        Case(
...
SUITES: dict[str, tuple[Dataset, Any, str]] = {
    "pipeline":                    (UNIFIED_DATASET,               make_pipeline_task("unified"),               "Pipeline Eval (Unified)"),
