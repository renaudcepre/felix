"""Shim — imports redirigés vers felix.graph.repositories."""
from felix.graph.repositories.beats import (  # noqa: F401
    create_narrative_beat,
    link_beat_character,
    list_all_narrative_beats,
)
from felix.graph.repositories.characters import (  # noqa: F401
    add_character_alias,
...
from felix.graph.repositories.groups import (  # noqa: F401
    create_member_of,
    list_all_groups,
    upsert_group_in_scene,
    upsert_group_minimal,
)
from felix.graph.repositories.issues import (  # noqa: F401
    create_issue,
...
from felix.graph.repositories.locations import (  # noqa: F401
    add_location_alias,
    get_location_detail,
    list_all_locations,
    upsert_location_minimal,
)
from felix.graph.repositories.scenes import (  # noqa: F401
...
from felix.graph.repositories.timeline import (  # noqa: F401
    get_timeline_rows,
